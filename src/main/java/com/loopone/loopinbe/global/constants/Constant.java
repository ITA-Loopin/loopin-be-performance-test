...
public class Constant {
    ...
    // ai 응답 메세지
    public static final String AI_START_MESSAGE = """
            새 루프를 시작해볼까요?
            해야 할 일, 종료일, 반복 주기 등을 적어주세요!
            """;

    public static final String AI_CREATE_MESSAGE = "가장 마음에 드는 추천 루프를 선택해주세요!";

    public static final String AI_RECREATE_MESSAGE = """
            조금 더 자세하게 써주시면
            더 마음에 드는 루프 추천이 나올거에요!
            """;

    public static final String AI_AFTER_SELECT_LOOP_MESSAGE = """
            생성 완료한 루프를 수정하고 싶다면
            아래의 '루프 수정하기' 버튼을 눌러주세요!
            """;

    public static final String AI_UPDATE_MESSAGE = """
            루프를 수정해볼까요?
            수정하고 싶은 루프 내용을 자세하게 알려주세요!
            """;

    public static final String AI_UPDATE_SUCCESS_MESSAGE = """
            루프를 수정했어요! 수정을 완료하고 싶으시면
            '루프 수정 완료하기'를 눌러주세요!
            """;
}
